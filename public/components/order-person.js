                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="person_first_name" class="form-control"
                                               v-model="form.first_name" name="first_name"  v-validate="'required|max:200'" data-vv-as="First name">
                                        <span class="error invalid-feedback d-block mb-2">{{ errors.first('first_name') }}</span>

                                    </div>
                                    <div class="form-group">
                                        <label for="person_last_name">Last name</label>
                                        <input type="text" id="person_last_name" class="form-control"
                                               v-model="form.last_name" name="last_name"  v-validate="'required|max:200'" data-vv-as="Last name">
                                        <span class="error invalid-feedback d-block mb-2">{{ errors.first('last_name') }}</span>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <span class="error invalid-feedback d-block mb-2">{{ errors.first('position') }}</span>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <span class="error invalid-feedback d-block mb-2">{{ errors.first('telegram') }}</span>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="person_skype" class="form-control" v-model="form.skype"
                                               name="skype">
                                        <span class="error invalid-feedback d-block mb-2">{{ errors.first('skype') }}</span>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="person_phone" class="form-control" v-model="form.phone"
                                               name="phone">
                                        <span class="error invalid-feedback d-block mb-2">{{ errors.first('phone') }}</span>
